...
class GoogleController extends Controller
{
    ...
    public function publishGoogleCalendar(Request $request) : JsonResponse
    {
        ...
        $calendar = new Google\Service\Calendar();
        ...
        DB::beginTransaction();
        try{
            $service = new \Google\Service\Calendar\Calendar($client);
            $createdCalendar = $service->calendars->insert();

            $modelCalendar = ModelsCalendar::findOrFail($request->calendar_id);
            $modelCalendar->published = true;
    ...
    private function getClient(): Google_Client
    {
        ...
        $applicationName = 'CalendarOrganizer';
